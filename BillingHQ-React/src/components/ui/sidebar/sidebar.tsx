...
import { BarChart3, Users, Building2, Globe, FileText, CreditCard, Receipt } from 'lucide-react';
...
function Sidebar() {
  ...
  return (
    <aside className='w-64 bg-gray-300/25 text-black h-screen p-4 flex flex-col border-r border-gray-300'>
              ...
              <li key={item.href} className="mb-1">
                <Link
                  ...
                  className={`
                    ...
                    ${isActive ? 'bg-[#46A2E3]/70 text-white' : 'hover:bg-[#46A2E3]/15'}
                  `}
                >
      ...
      <div className='mt-auto p-4 border-t border-gray-300 text-xs text-gray-600'>
